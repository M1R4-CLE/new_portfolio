...
export default function Carousel3D({
  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center px-10 [perspective:2000px] md:px-14">
      <div className="relative [transform-style:preserve-3d] scale-[0.85]">
        <div
